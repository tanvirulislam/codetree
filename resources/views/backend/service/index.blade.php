...
@section('body')
  <div class="page-title-area">
            ...
            <div class="main-content-inner">
                <div class="row">
                   <div class="col-3">
                    @if (Auth::guard('admin')->user()->can('service.create'))
                    <a class="btn btn-primary" href="{{route('admin.service.create')}}" role="button" >Create New service </a>
                    @endif
                   </div>
                    <div class="col-3">
                   </div>
               ...
               <div class="row">
                ...
                <td>{{$category->name}}</td>
                               ...
                               @if (Auth::guard('admin')->user()->can('service.edit'))
                                    <a class="btn btn-info text-white" href="{{ route('admin.service.edit',$category->id) }}" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
...
@if (Auth::guard('admin')->user()->can('service.delete'))
                    ...
                    <form id="delete-form-{{ $category->id }}" action="{{ route('admin.service.delete',$category->id) }}" method="POST" style="display: none;">
                      @method('DELETE')
                                                    @csrf
