                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.news.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <input type="text" class="form-control"  name="title" placeholder="Enter a  Name" value="{{ $view->title }}">
...
<textarea class="form-control"  name="des" placeholder="Enter a  Comment">
     {{ $view->des }}
</textarea>
