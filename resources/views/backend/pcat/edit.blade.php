...
@section('title')
Portfolio Category Update - Admin Panel
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Portfolio Category Update</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.portfolio_category') }}">All Portfolio Category</a></li>
                    <li><span>Update Portfolio Category</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Update New Portfolio Category</h4>
                   
                    
                    <form action="{{ route('admin.portfolio_category.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
...
<div class="row">
                            ...
                            <select class="form-control" name="status">
                                <option value="1"{{ $view->status == 1 ? 'selected':''}}>Active</option>
                                 <option value="0"{{ $view->status == 0 ? 'selected':''}}>InActive</option>
                            </select>
                        </div>  
                            </div>
