                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Client</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="{{route('admin.dashboard')}}">DashBoard</a></li>
                                <li><span>All Client</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                <div class="row">
                   <div class="col-3">
                    ...
                    <a class="btn btn-primary" href="{{route('admin.client_logo.create')}}" role="button" >Create New Client</a>
                    @endif
                   </div>
                    <div class="col-3">
                   </div>
               ...
               <div class="row">
                ...
                <td>{{$category->name}}</td>
                               ...
                               @if (Auth::guard('admin')->user()->can('client.edit'))
                                    <a class="btn btn-info text-white" href="{{ route('admin.client_logo.edit',$category->id) }}" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
                                    @endif
@if (Auth::guard('admin')->user()->can('client.delete'))
                    ...
                    <form id="delete-form-{{ $category->id }}" action="{{ route('admin.client_logo.delete',$category->id) }}" method="POST" style="display: none;">
                      @method('DELETE')
                                                    @csrf
