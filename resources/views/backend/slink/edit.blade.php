...
@section('title')
Social Link Update - Admin Panel
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Social Link Update</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.team_social_link') }}">All Social Link</a></li>
                    <li><span>Update Social Link</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Update Social Link</h4>
                   
                    
                    <form action="{{ route('admin.team_social_link.update') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
...
<option value="{{ $team->name }}" {{ $social->user_name == $team->name ? 'selected':'' }}>{{ $team->name }}</option>
                               @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="row form-group">
                       <label class="control-label col-md-3">Facebook:</label>
                        <div class="col-md-9">
                            <input type="text" name="f_link" class="form-control" value="{{ $social->f_link }}">
                    ...
                    <div class="row form-group">
                       <label class="control-label col-md-3">Instagram:</label>
                        <div class="col-md-9">
                            <input type="text" name="ins_link" class="form-control" value="{{ $social->ins_link }}">
                    ...
                    <div class="row form-group">
                       <label class="control-label col-md-3">LinkedIn:</label>
                        <div class="col-md-9">
                            <input type="text" name="linkin_link" class="form-control" value="{{ $social->linkin_link }}">
                        </div>
                    </div>
                    <div class="row form-group">
                       <label class="control-label col-md-3">Github:</label>
                        <div class="col-md-9">
                            <input type="text" name="git_link" class="form-control" value="{{ $social->git_link }}">
                        </div>
                    </div>
                    <div class="row form-group">
                       <label class="control-label col-md-3">Youtube:</label>
                        <div class="col-md-9">
                            <input type="text" name="you_link" class="form-control" value="{{ $social->you_link }}">
                        </div>
                    </div>
                    <div class="row form-group">
                       <label class="control-label col-md-3">Pinterest:</label>
                        <div class="col-md-9">
                            <input type="text" name="pin_link" class="form-control" value="{{ $social->pin_link }}">
                        </div>
                    </div>
