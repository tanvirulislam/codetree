        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.about') }}">All About</a></li>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Add About</h4>
                    ...
                    <form action="{{ route('admin.about.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <label for="name">About Video</label>
                            <input type="file" class="form-control"  name="video_one" placeholder="Enter a  About Video">
                        </div>  
                            </div>
                            ...
                            <input type="file" class="form-control"  name="video_two" placeholder="Enter a  About Video">
                        </div>  
                            </div>
                            <div class="col-md-12">
                              <div class="form-group">
                            <label for="name">Description</label>
<textarea class="form-control"  name="des" placeholder="Enter a  Description"></textarea>
