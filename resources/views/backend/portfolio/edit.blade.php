    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Portfolio  Update</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.portfolio') }}">All Portfolio</a></li>
                    <li><span>Update Portfolio</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Update New Portfolio</h4>
                    ...
                    <form action="{{ route('admin.portfolio.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <select class="form-control" name="cat_id">
                                ...
                                <option value="{{$category->slug}}" {{ $category->slug == $view->cat_id ? 'selected':'' }}>{{ $category->name }}</option>
                                 @endforeach
                            </select>
                        </div>  
                            </div>
                        ...
                        <div class="row">
                            ...
                            <input type="text" class="form-control"  name="title" placeholder="Enter a  Title" value="{{ $view->title }}">
                        </div>  
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
                            <label for="name">Client Name</label>
                            <input type="text" class="form-control"  name="c_name" placeholder="Enter a  Client Name" value="{{ $view->c_name }}">
                        </div>  
                            </div>
                            ...
                            <input type="text" class="form-control"  name="link" placeholder="Enter a  Link" value="{{ $view->link }}">
                        </div>  
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
...
<div class="row">
                      ...
                      <textarea class="textarea" name="des" placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!! $view->des !!}</textarea>
                      </div> 
                            </div>
                        ...
                        <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Update Portfolio</button>
                    </form>
                </div>
            </div>
        </div>
