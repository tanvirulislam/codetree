    ...
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                ...
                <input type="text" class="form-control"  name="id" placeholder="Enter a  Name" value="{{ $view->id }}">
                        </div>  
                            </div>
                            ...
                            <select class="form-control" name="type">
                                <option value="1" {{ $view->type == 1 ? 'selected':''}}>Adviser</option>
                                <option value="0" {{ $view->type == 0 ? 'selected':''}}>Team Member</option>
                            </select>
                        </div>  
                            </div>
                            ...
                            <input type="file" class="form-control"  name="image" placeholder="Enter a  title">
                        </div>  
                            </div>
