        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.review') }}">All Review</a></li>
                    <li><span>Update Review</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Update Review</h4>
                    ...
                    <input type="hidden" class="form-control"  name="id" placeholder="Enter a  Name" value="{{ $view->id }}">
                            ...
                            <input type="text" class="form-control"  name="title" placeholder="Enter a  Designation" value="{{ $view->title }}">
                        </div>  
                            </div>
                            <div class="col-md-4">
                              <div class="form-group">
                            <label for="name">Company Name</label>
                            <input type="text" class="form-control"  name="c_name" placeholder="Enter Company Name" value="{{ $view->c_name }}">
                        </div>  
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                            <label for="name">Link</label>
                            <input type="text" class="form-control"  name="link" placeholder="Link" value="{{ $view->link }}">
                        </div>  
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
...
<textarea class="form-control"  name="com" placeholder="Enter a  Comment">{{$view->com }}</textarea>
