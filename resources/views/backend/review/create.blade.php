                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.review.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <input type="text" class="form-control"  name="title" placeholder="Enter a  Designation">
                        </div>  
                            </div>
                            <div class="col-md-4">
                              <div class="form-group">
...
<textarea class="form-control"  name="com" placeholder="Enter a  Comment"></textarea>
