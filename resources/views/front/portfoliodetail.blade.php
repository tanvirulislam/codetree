...
@endsection
  @section('body')
      ...
      <section id="portfolio-web" class="py-3">
      <div class="container" data-aos="fade-up" data-aos-duration="1200">
        <div class="portfolio-container">
          <div class="portfolio-header">
            <h1 class="uppercase">{{ $portfolioscat }}</h1>
            <p>We work with multiple projects. these are some of our best works so far.</p>
          </div>
          <div class="portfolio-content-background">
            <div class="portfolio-content">
              ...
              <div class="portfolio-item">
                <a href="{{ route('portfoliosingle',$portfolio->slug) }}">
                  <div class="img-div">
